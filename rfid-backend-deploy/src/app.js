...
app.use(cors({
    origin: [
        ...
        'https://rfid-attendance-frontend-ecru.vercel.app',
        'http://localhost:5173'
    ],
    credentials: true
}));
...
app.get('/api/health', async (req, res) => {
    try {
        // Use a simple query to check database connectivity instead of $runCommandRaw
        await app.locals.prisma.user.findFirst({ take: 1 });
