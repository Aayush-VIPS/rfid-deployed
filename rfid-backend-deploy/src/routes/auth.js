...
import prisma from '../services/prisma.js'; // ✅ ADDED: Import prisma directly instead of using req.app.locals
...
router.post('/refresh-token', async (req, res, next) => {
    ...
    try {
        ...
        // ✅ IMPROVED: Add proper error handling for token verification
...
router.post('/create-admin-user', async (req, res, next) => {
    ...
    try {
        // ✅ IMPROVED: Use imported prisma instead of req.app.locals.prisma
