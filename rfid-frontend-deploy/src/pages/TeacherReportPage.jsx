...
function TeacherReportPage() {
  ...
  const [reportFilters, setReportFilters] = useState({
    from: '',
    to: getCurrentDateInIST(), // Default 'to' to today in IST
  });
  ...
  const handleGenerateReport = async (e) => {
    ...
    try {
      ...
      const response = await api.get(`/api/report/section/${sectionId}`, {
        params: { from, to },
      });
      setReportData(response.data.data); // Backend returns { success: true, data: [...] }
  ...
  return (
    <div className="teacher-report-page-container">
      ...
      <div className="report-main-content">
        ...
        <div className="header-container" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '20px' }}>
          <h1 className="report-page-title">Fetching Attendance</h1>
